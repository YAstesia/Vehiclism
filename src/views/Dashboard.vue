...
<template>
    <div class="grid grid-cols-12 gap-8">
        <div class="col-span-12 xl:col-span-6">
            ...
            <div class="card">
                <div class="flex justify-between items-center mb-6">
                    <div class="font-semibold text-xl">7日内热销品牌 Top3</div>
                </div>
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">每日销售行情（单位：辆）</div>
            ...
            <div class="card">
                ...
                <ul class="p-0 m-0 list-none mb-6">
                    <li class="flex items-center py-2 border-b border-surface">
                        ...
                        <span class="text-surface-900 dark:text-surface-0 leading-normal"
                            >
                            <span class="text-surface-700 dark:text-surface-100 font-bold">2024年6月汽车销量 <span class="text-primary font-bold" style="font-size: 22pt; margin-left: 5px; margin-right: 5px;">177.1</span>万辆</span>
                        </span>
                    </li>
                </ul>
                ...
                <ul class="p-0 m-0 list-none mb-6">
                    <li class="flex items-center py-2 border-b border-surface">
                        ...
                        <span class="text-surface-900 dark:text-surface-0 leading-normal"
                            >
                            <span class="text-surface-700 dark:text-surface-100 font-bold">2024年6月新能源汽车销量<span class="text-primary font-bold" style="font-size: 22pt; margin-left: 5px; margin-right: 5px;">83.1</span>万辆</span>
                        </span>
                    </li>
                </ul>
                ...
                <ul class="p-0 m-0 list-none mb-6">
                    <li class="flex items-center py-2 border-b border-surface">
                        <div class="w-12 h-12 flex items-center justify-center bg-red-100 dark:bg-blue-400/10 rounded-full mr-4 shrink-0">
                            <i class="pi pi-dollar !text-xl text-red-500"></i>
                        </div>
                        <span class="text-surface-900 dark:text-surface-0 leading-normal"
                            >
                            <span class="text-surface-700 dark:text-surface-100 font-bold">2024年汽车累计销量 <span class="text-primary font-bold" style="font-size: 22pt; margin-left: 5px; margin-right: 5px;">992.5</span>万辆</span>
                        </span>
                    </li>
                </ul>
                ...
                <ul class="p-0 m-0 list-none mb-6">
                    <li class="flex items-center py-2 border-b border-surface">
                        ...
                        <span class="text-surface-900 dark:text-surface-0 leading-normal"
                            >
                            <span class="text-surface-700 dark:text-surface-100 font-bold">2024年新能源汽车累计销量 <span class="text-primary font-bold" style="font-size: 22pt; margin-left: 5px; margin-right: 5px;">405.2</span>万辆</span>
                        </span>
                    </li>
                </ul>
